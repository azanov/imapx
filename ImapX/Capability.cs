...
namespace ImapX
{
    public class Capability
    {
        ...
        public bool Binary
        {
            get { return All.Contains("BINARY"); }
        }
        ...
        {
            get { return All.Contains("CATENATE"); }
        }
        ...
        {
            get { return All.Contains("CHILDREN"); }
        }
        ...
        {
            get { return All.Contains("CONDSTORE"); }
        }
        ...
        public bool Convert
        {
            get { return All.Contains("CONVERT"); }
        }
        ...
        {
            get { return All.Contains("CREATE-SPECIAL-USE"); }
        }
        ...
        public bool Enable
        {
            get { return All.Contains("ENABLE"); }
        }
        ...
        public bool ESearch
        {
            get { return All.Contains("ESEARCH"); }
        }
        ...
        public bool Filters
        {
            get { return All.Contains("FILTERS"); }
        }
        ...
        public int? I18NLevel
        {
            get
            {
                try
                {
                    string tmp = All.FirstOrDefault(_ => _.StartsWith("I18NLEVEL="));
        ...
        {
            get { return All.Contains("LOGINDISABLED"); }
        }
        ...
        {
            get { return All.Contains("METADATA"); }
        }
        ...
        {
            get { return All.Contains("NAMESPACE"); }
        }
        ...
        public bool XOAuth
        {
            get { return AuthenticationMechanisms.Contains("XOAUTH"); }
        }
        ...
        public bool XOAuth2
        {
            get { return AuthenticationMechanisms.Contains("XOAUTH2"); }
        }
        ...
        {
            get { return All.Contains("UNSELECT"); }
        }

        public bool XList
        {
            get { return All.Contains("XLIST"); }
        }

        public bool XGMExt1
        {
            get { return All.Contains("X-GM-EXT-1"); }
        }
